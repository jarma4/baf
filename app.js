...
var oddsId = crontab.scheduleJob("*/15 8-22 * * *", scraper.refreshOddsInfo);
var clearUnactedId = crontab.scheduleJob("*/10 12-21 * * *", scraper.clearUnactedBets);
// var checkNflScoresId = crontab.scheduleJob("*/1 * * * *", scraper.checkScores,['nfl']);
var checkNflScoresId = crontab.scheduleJob("*/10 15,19,22 * * 0,1,4,6", scraper.checkScores,['nfl']);
var checkNbaScoresId = crontab.scheduleJob("*/15 19-23 * * *", scraper.checkScores,['nba']);
var tallyBetsId = crontab.scheduleJob("0 16,20,23 * * 0,1,4,6", scraper.tallyBets);
