...
const oddsCron = crontab.scheduleJob("*/10 10-22 * * *", scraper.refreshOddsInfo);
...
// const checkScoresNbaCron = crontab.scheduleJob("* 0,15-23 * * *", scraper.checkScores,['nba']);
const tallyBetsNbaCron = crontab.scheduleJob("*/10 0,15-23 * * *", scraper.tallyBets2,['nba']);
