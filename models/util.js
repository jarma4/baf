...
module.exports = {
   ...
   getWeek: (date, sport) => {
	...
	nbaTeams: {
		'Hawks': 'ATL','Atlanta': 'ATL', 'Bulls': 'CHI','Chicago': 'CHI', 'Mavericks': 'DAL','Dallas': 'DAL', 'Pistons': 'DET','Detroit': 'DET',  'Timberwolves': 'MIN','Minnesota': 'MIN', 'Pelicans': 'NOP','New Orleans': 'NOP', 'Knicks': 'NYK', 'New York': 'NYK', 'Nets': 'BKN', 'Brooklyn': 'BKN', '76ers': 'PHI', 'Philadelphia': 'PHI', 'Thunder': 'OKC', 'Oklahoma City': 'OKC', 'Clippers': 'LAC','L.A. Clippers': 'LAC','Lakers': 'LAL','L.A. Lakers': 'LAL', 'Wizards': 'WAS','Washington': 'WAS', 'Cavaliers': 'CLE','Cleveland': 'CLE', 'Nuggets': 'DEN','Denver': 'DEN', 'Rockets': 'HOU', 'Houston': 'HOU', 'Pacers': 'IND', 'Indiana': 'IND', 'Heat': 'MIA', 'Miami': 'MIA', 'Celtics': 'BOS','Boston': 'BOS', 'Warriors': 'GSW', 'Golden St.': 'GS', 'Spurs': 'SAS', 'San Antonio': 'SAS', 'Kings': 'SAC', 'Sacramento': 'SAC', 'Trail Blazers': 'POR', 'Portland': 'POR', 'Magic': 'ORL', 'Orlando': 'ORL', 'Hornets': 'CHA', 'Charlotte': 'CHA', 'Suns': 'PHX', 'Phoenix': 'PHX', 'Raptors': 'TOR', 'Toronto': 'TOR', 'Bucks': 'MIL', 'Milwaukee': 'MIL', 'Jazz': 'UTA', 'Utah': 'UTA', 'Grizzlies': 'MEM', 'Memphis': 'MEM'
	}
};
